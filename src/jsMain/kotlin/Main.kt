...
import kotlinx.datetime.internal.JSJoda.Period
...
class About(private val rootId: String = "about") : Application() {
    ...
    override fun start() {
        val totalCareerYear = Period.between(LocalDate.of(2022, 9, 19), LocalDate.now(ZoneId.of("KST")))
            ...
            flexPanel(FlexDirection.ROW, justify = JustifyContent.CENTER) {
                div(className = "aboutWrap") {
                    ...
                    p(className = "introduce") {
                        content = """
                            안녕하세요, ${LocalDateTime.parse(totalCareerYear.toString())}년차 백엔드 엔지니어 전지환입니다.
